...
## 🚀 Objetivo
Unir minha experiência em **gestão, liderança e produção audiovisual** com novas competências em **tecnologia e análise de dados**, buscando agregar valor em projetos que envolvam **estratégia, inovação e transformação digital**.
...
- MBA em Gestão de Negócios – Senac Ribeirão Preto  
- Graduação em Gestão de Marketing – Moura Lacerda  
- Nanodegree em Marketing Digital – Udacity  
- Certificações: IA Generativa (Universia), Python Back-end (Santander/DIO), Power BI (Data Science Academy)
...
✨ Sempre em busca de novos desafios e oportunidades para aplicar **dados, tecnologia e criatividade** em soluções estratégicas.
